...
export default function FlashCard({
  ...
  return (
    <div className="h-full flex flex-row-reverse w-full absolute z-999 bg-amber-50/50 font-sans">
      <div
      ...
      <div className="border-6 md:border-16 flex flex-col mx-auto w-full max-w-[95vw] md:max-w-[85vw] lg:max-w-250 h-fit max-h-[96vh] my-auto rounded-xl border-[#8e0000] bg-[#de9a35] shadow-[inset_0_0px_18px_rgba(0,0,0,0.6)] pb-4 md:pb-10 overflow-hidden">
        <div className="flex flex-col md:flex-row px-2 md:px-0 justify-center">
